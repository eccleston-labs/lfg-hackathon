...
import { PlaceSearch } from "./ReportModal/PlaceSearch";
import { ImageUpload } from "./ReportModal/ImageUpload";

interface TextReportFormProps {
...
export default function TextReportForm({
  formData,
  onInputChange,
  onPlaceSelect,
  onSubmit,
    ...
    <form onSubmit={onSubmit} className="p-6 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          />
          {postcodeError && (
            <div ref={errorRef} className="text-red-600 text-sm mb-2">
              {postcodeError}
            </div>
          )}
        </div>
